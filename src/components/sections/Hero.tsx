 ...
 *   Cursor Orange (#f54e00) primary CTA, and white IDE mockup on warm cream canvas.
 */
    ...
    <section className="relative pt-12 pb-20 md:pt-20 md:pb-28 bg-[#f7f7f4]">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-[#e6e5e0] bg-white px-3.5 py-1 text-xs text-[#5a5852] hover:border-[#cfcdc4] transition-all mb-8 shadow-none">
          ...
          <span className="font-mono text-[11px] font-semibold text-[#f54e00]">GlasSQL 0.1.0</span>
        ...
        <h1 className="mx-auto max-w-4xl text-4xl font-normal tracking-[-0.035em] text-[#26251e] sm:text-6xl sm:leading-[1.1] lg:text-7xl">
          Workspace data operations—
          <span className="block text-[#5a5852]">
            without opening production DBs.
          </span>
        </h1>

        {/* Subhead */}
        <p className="mx-auto mt-6 max-w-2xl text-base text-[#5a5852] sm:text-lg sm:leading-relaxed font-normal">
          Publish scoped snapshots, run SQL in browser or desktop via PGlite WASM, explore schemas, and ship queryable replicas with 3-tier audits and Cursor MCP integration.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <SurfaceButton to="/download" tone="dark" size="md">
            <IconDownload className="size-4 text-[#f7f7f4]/80" />
