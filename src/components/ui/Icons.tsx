/**
 * @file Icons.tsx
 * @description Inline SVG icons for navigation, platform actions, database tools, and status badges.
 */
...
export function IconExternalLink({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        d="M6.194 6.75a.75.75 0 0 1 0-1.06l7.5-7.5a.75.75 0 1 1 1.06 1.06l-7.5 7.5a.75.75 0 0 1-1.06 0Z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function IconTerminal({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconCheck({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      viewBox="0 0 20 20"
      fill="currentColor"
      className={cn("size-4 shrink-0 text-[#1f8a65]", className)}
      {...props}
    >
      <path
        fillRule="evenodd"
...
export function IconCpu({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconTable({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
