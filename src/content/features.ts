...
export const HOME_CHAPTERS: FeatureChapterContent[] = [
  {
    ...
    pills: ["Scoped Extraction", "Workspace PG (WASM)", "No VPN Required", "Reproducible Replicas"],
    mock: "data-snapshot",
    frame: "web",
  },
  {
...
export const PRODUCT_CHAPTERS: FeatureChapterContent[] = [
  {
    ...
    body: "Curate data slices directly from production or staging, bundle them into verifiable snapshots, and load them into Workspace PG (WASM) instances. Your production database stays completely isolated.",
  ...
  },
  {
    ...
    pills: ["Tauri v2 Native", "Workspace PG (WASM) & DuckDB", "Air-Gapped Local Mode", "Encrypted Backup Packs"],
    mock: "dual-runtime",
    frame: "mac",
    reverse: true,
  },
