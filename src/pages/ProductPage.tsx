    ...
    <>
      ...
      <PageShell>
        <PageIntro
          ...
          lead="Open source and free forever. GlasSQL replaces loose SQL scratchpads and risky database credentials with versioned query templates, Workspace PG (WASM) replicas, and automated query endpoints."
        >
